  ...
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-3 p-4">
        <div className="text-xs uppercase tracking-wide text-neutral-500">Controlled context menu</div>
        <div
          className="rounded-lg border border-neutral-700/60 bg-neutral-900/40 p-10 text-sm text-neutral-300"
          onContextMenu={(event) => {
        ...
        <div className="text-xs text-neutral-500">Last action: {lastAction}</div>
...
export const Uncontrolled: Story = {
  ...
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-3 p-4">
        <div className="text-xs uppercase tracking-wide text-neutral-500">Uncontrolled with helper wrapper</div>
        <WithContextMenu
        ...
        >
          {({ openMenu }) => (
            <div className="flex items-center gap-3">
              ...
              <div
                className="rounded-md border border-neutral-700/60 px-3 py-2 text-xs text-neutral-400"
